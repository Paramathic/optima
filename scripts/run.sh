...
do
    ...
    #                                    SCALE_IMPORTANT_WEIGHTS='--scale_important_weights'
                                        MASKLLM_CHECKPOINT="--maskllm_checkpoint prox_sparse_ckpt/up_down_gate_proximal_merged_Llama-3.1-8B-en_sft_final_400_lr5e-05_len4096_batch1_lambda0.85.pt"
                                        # WANDB="--use_wandb"
