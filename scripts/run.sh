...
MODEL_PREFIX=facebook/opt- #meta-llama/Meta-Llama-3.1- #mistralai/Mistral- #meta-llama/Llama-2- #facebook/opt-
#MODEL_POSTFIX=-hf #-v0.3 #-hf

for MODEL_SIZE in 125m #125m 350m 1.3b 2.7b 6.7b #13b # 7b #7b 13b #8B #7B #125m # 7b #1.3b #7B #6.7b
do
